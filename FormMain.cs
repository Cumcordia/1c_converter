        ...
        {   
            ...
            using (var conn = new NpgsqlConnection(connString))
            {
                ...
                foreach (var filePath in filePaths)
                {
                    ...
                    using (var cmd = new NpgsqlCommand("INSERT INTO \"DataModel\" (filename, filedata, upload_date, ConvertDateAndTime, FileOriginalName, FileConvertedName) VALUES (@filename, @filedata, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, @vinputFile, @vinputFile)", conn))
                    {
